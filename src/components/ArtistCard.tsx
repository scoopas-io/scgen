...
import { ChevronDown, ChevronUp, Copy, Check, User, Mic, Disc, Music } from "lucide-react";
      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="h-14 w-14 rounded-full gradient-gold flex items-center justify-center glow-gold">
